...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.SiteID = field.NewInt32(tableName, "site_id")
	_config.AppModule = field.NewString(tableName, "app_module")
	_config.ConfigKey = field.NewString(tableName, "config_key")
	_config.Value = field.NewString(tableName, "value")
	_config.ConfigDesc = field.NewString(tableName, "config_desc")
	_config.IsUse = field.NewInt32(tableName, "is_use")
	_config.CreateTime = field.NewUint(tableName, "create_time")
	_config.ModifyTime = field.NewInt32(tableName, "modify_time")
...
type config struct {
	...
	ALL        field.Asterisk
	ID         field.Int32  // 主键
	SiteID     field.Int32  // 站点id（店铺，分站）,总平台端为0
	AppModule  field.String // 应用端口关键字
	ConfigKey  field.String // 配置项关键字
	Value      field.String // 配置值json
	ConfigDesc field.String // 描述
	IsUse      field.Int32  // 是否启用 1启用 0不启用
...
func (c *config) updateTableName(table string) *config {
	...
	c.SiteID = field.NewInt32(table, "site_id")
	c.AppModule = field.NewString(table, "app_module")
	...
	c.IsUse = field.NewInt32(table, "is_use")
	c.CreateTime = field.NewUint(table, "create_time")
	c.ModifyTime = field.NewInt32(table, "modify_time")
