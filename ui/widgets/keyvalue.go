...
func (kv *KeyValue) itemLayout(gtx layout.Context, theme *apptheme.Theme, index int, item *KeyValueItem) layout.Dimensions {
...
func (kv *KeyValue) Layout(gtx layout.Context, theme *apptheme.Theme) layout.Dimensions {
	items := kv.Items
	if kv.filterText != "" {
...
func (kv *KeyValue) WithAddLayout(gtx layout.Context, title, hint string, theme *apptheme.Theme) layout.Dimensions {
