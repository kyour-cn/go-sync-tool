...
func NewDropDown(theme *apptheme.Theme, options ...*DropDownOption) *DropDown {
	c := &DropDown{
		menuContextArea: component.ContextArea{
...
func NewDropDownWithoutBorder(theme *apptheme.Theme, options ...*DropDownOption) *DropDown {
	c := &DropDown{
		menuContextArea: component.ContextArea{
			Activation:       pointer.ButtonPrimary,
			AbsolutePosition: true,
...
func (c *DropDown) box(gtx layout.Context, theme *apptheme.Theme, text string, maxWidth unit.Dp) layout.Dimensions {
...
// Layout the DropDown.
func (c *DropDown) Layout(gtx layout.Context, theme *apptheme.Theme) layout.Dimensions {
...
func (c *DropDown) updateMenuItems(theme *apptheme.Theme) {
	...
	for _, opt := range c.options {
		...
		c.menu.Options = append(c.menu.Options, func(gtx layout.Context) layout.Dimensions {
			...
			itm.Label.Color = apptheme.White
