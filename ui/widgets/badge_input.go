...
func (b *BadgeInput) itemLayout(gtx layout.Context, theme *apptheme.Theme, item *BadgeInputItem) layout.Dimensions {
...
func (b *BadgeInput) Layout(gtx layout.Context, theme *apptheme.Theme) layout.Dimensions {
	for i := range b.Items {
