...
func (t *TreeView) clickableWrap(gtx layout.Context, theme *apptheme.Theme, node *TreeNode, widget layout.Widget) layout.Dimensions {
...
func (t *TreeView) controlLayout(gtx layout.Context, theme *apptheme.Theme, node *TreeNode) layout.Dimensions {
...
func (t *TreeView) itemLayout(gtx layout.Context, theme *apptheme.Theme, node *TreeNode) layout.Dimensions {
    leftPadding := 4
...
// TreeNodes.
func (t *TreeView) LayoutTreeNode(gtx layout.Context, theme *apptheme.Theme, node *TreeNode) layout.Dimensions {
    if !node.menuInit {
        node.menuInit = true
...
func (t *TreeView) Layout(gtx layout.Context, theme *apptheme.Theme) layout.Dimensions {
    nodes := t.nodes
    if t.filterText != "" {
